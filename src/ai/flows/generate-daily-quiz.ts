...
You will generate a daily quiz with {{numberOfQuestions}} multiple-choice questions on the topic of {{topic}}. You should generate questions from a balanced mix of main topics and sub-topics from the syllabus provided. Each question should have four options, and clearly identify the correct answer.
